...
const adminController = {
    ...
    system: async (req, res, next) => {
        try {
            let { nameSite, defaultTitle, description, keywords, headerScript, favicon, thumbnail, gameNote, limitPhone, paymentComment, withdrawComment, missionData, topData, history, refund, notification, jackpot, jackpotCount, muster, siteStatus } = req.body;
            let data = await settingModel.findOneAndUpdate({}, { $set: { nameSite, defaultTitle, description, keywords, headerScript, favicon, thumbnail, gameNote, limitPhone, paymentComment, withdrawComment, missionData, topData, history, refund, notification, jackpot, jackpotCount, muster, siteStatus } });
